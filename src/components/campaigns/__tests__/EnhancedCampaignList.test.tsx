...
describe('EnhancedCampaignList', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders all campaigns', () => {
      ...
      expect(
        screen.getByText('LED Street Lighting Project')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Community Garden Initiative')
      ).toBeInTheDocument();
    });

    it('shows swipe instructions when swipe voting is enabled', () => {
      render(
        <EnhancedCampaignList {...defaultProps} enableSwipeVoting={true} />
      );

      expect(screen.getByText('Swipe to Vote')).toBeInTheDocument();
      expect(
        screen.getByText(
          'Swipe right to support campaigns, left to oppose. Quick swipes count too!'
        )
      ).toBeInTheDocument();
    });
    ...
    it('hides swipe instructions when swipe voting is disabled', () => {
      render(
        <EnhancedCampaignList {...defaultProps} enableSwipeVoting={false} />
      );
  ...
  describe('Empty State', () => {
    it('shows empty state when no campaigns', () => {
      ...
      expect(
        screen.getByText('Be the first to create a campaign in your area!')
      ).toBeInTheDocument();
    ...
    it('shows custom empty message when provided', () => {
      ...
      expect(
        screen.getByText('All campaigns are currently inactive')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Voting Integration', () => {
    ...
    it('gets user vote status correctly', () => {
      const getUserVote = jest.fn((id) =>
        id === 'campaign-1' ? 'SUPPORT' : null
      );
      render(
        <EnhancedCampaignList
          {...defaultProps}
  ...
  describe('Error Handling', () => {
    it('shows error boundary fallback for failed campaigns', () => {
      ...
      render(
        <EnhancedCampaignList {...defaultProps} campaigns={[errorCampaign]} />
      );
  ...
  describe('Performance Features', () => {
    it('shows performance stats in development mode', () => {
      ...
      expect(
        screen.getByText(/Enhanced Touch-Optimized Voting Interface Active/)
      ).toBeInTheDocument();
    ...
    it('hides performance stats in production mode', () => {
      ...
      expect(
        screen.queryByText(/Enhanced Touch-Optimized Voting Interface Active/)
