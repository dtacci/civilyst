...
import { getDeviceId, isFingerprintingAvailable } from '~/lib/trust/deviceFingerprint';
...
jest.mock('~/components/wonder/VoiceRecorder', () => ({
  VoiceRecorder: ({ onResponse }: { onResponse: (url: string, text: string) => void }) => (
...
describe('AnonymousWonderButton', () => {
  beforeEach(() => {
    ...
    (api.wonders.createAnonymous.useMutation as jest.Mock).mockReturnValue(mockMutation);
  ...
  describe('Modal interaction', () => {
    it('should open modal when button is clicked', async () => {
      ...
      expect(screen.getByText('No signup required - just share what you\'re wondering about')).toBeInTheDocument();
    });
    ...
    it('should close modal when X button is clicked', async () => {
      ...
      // Open modal
      const openButton = screen.getByRole('button', { name: /wonder anonymously/i });
      ...
      expect(screen.queryByText('Share Your Wonder ✨')).not.toBeInTheDocument();
    });
    ...
    it('should close modal when clicking backdrop', async () => {
      ...
      // Click backdrop
      const backdrop = screen.getByText('Share Your Wonder ✨').closest('.fixed');
  ...
  describe('Text input', () => {
    ...
    it('should show placeholder text in textarea', async () => {
      ...
      const textarea = screen.getByPlaceholderText(/what would make your community better/i);
  ...
  describe('Category selection', () => {
    ...
    it('should display all available categories', async () => {
      ...
      expect(screen.getByRole('button', { name: /recreation/i })).toBeInTheDocument();
  ...
  describe('Location sharing', () => {
    it('should toggle location sharing', async () => {
      ...
      const locationButton = screen.getByRole('button', { name: /share location \(optional\)/i });
      ...
      await waitFor(() => {
        expect(screen.getByRole('button', { name: /location shared/i })).toBeInTheDocument();
      });
    });
  ...
  describe('Form submission', () => {
    it('should submit wonder with text content', async () => {
      ...
      // Submit
      const submitButton = screen.getByRole('button', { name: /share wonder anonymously/i });
  ...
  describe('Success handling', () => {
    it('should show success message and reset form on successful submission', async () => {
      ...
      (api.wonders.createAnonymous.useMutation as jest.Mock).mockImplementation(({ onSuccess }) => {
  ...
  describe('Error handling', () => {
    it('should show error message on submission failure', async () => {
      ...
      (api.wonders.createAnonymous.useMutation as jest.Mock).mockImplementation(({ onError }) => {
      ...
      expect(toast.error).toHaveBeenCalledWith('Error sharing wonder: Network error');
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should support keyboard navigation', async () => {
      ...
      // Tab to the button
      await userEvent.tab();
      expect(screen.getByRole('button', { name: /wonder anonymously/i })).toHaveFocus();
