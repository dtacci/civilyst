...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private handleReportBug = () => {
    if (this.props.showReportDialog && Sentry.showReportDialog) {
      ...
      alert('An error occurred. Our team has been notified. Please try again later.');
    }
  };
            ...
            <div className="max-w-md rounded-lg bg-white p-8 shadow-lg">
              ...
              <div className="space-y-3">
                ...
                {this.props.showReportDialog && (
                  <Button onClick={this.handleReportBug} variant="secondary" className="w-full">
                    Report Bug
                  </Button>
                )}
              </div>
              ...
              {isDevelopment && this.state.error && (
                <div className="mt-8 rounded-md bg-gray-100 p-4 text-left text-sm text-gray-800">
                  <h3 className="mb-2 font-semibold">Error Details (Development Only):</h3>
