...
const cardVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: ['bg-[--color-surface-elevated] border-[--color-border]'],
        elevated: [
      ...
      size: {
        sm: ['p-3 gap-2', 'rounded-[--border-radius-md]'],
        default: ['p-4 gap-3', 'rounded-[--border-radius-lg]'],
        lg: ['p-6 gap-4', 'rounded-[--border-radius-xl]'],
      },
      interactive: {
        true: [
          'cursor-pointer',
