...
export const aiRouter = createTRPCRouter({
  ...
  generateSuggestion: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      const savedSuggestion = await db.contentSuggestion.create({
        data: {
  ...
  getSuggestions: protectedProcedure
    ...
    .query(async ({ ctx: _ctx, input }) => {
      return db.contentSuggestion.findMany({
  ...
  applySuggestion: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      return db.contentSuggestion.update({
  ...
  moderateContent: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      const savedModeration = await db.contentModeration.create({
        data: {
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      for (let i = 0; i < results.length; i++) {
        ...
        if (result.status === 'fulfilled') {
          ...
          const saved = await db.contentModeration.create({
            data: {
  ...
  generateSummary: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      const savedSummary = await db.campaignSummary.upsert({
        where: { campaignId: input.campaignId },
        create: {
          campaignId: input.campaignId,
  ...
  getSummary: protectedProcedure
    .input(z.object({ campaignId: z.string() }))
    .query(async ({ ctx: _ctx, input }) => {
      return db.campaignSummary.findUnique({
        where: { campaignId: input.campaignId },
      });
    }),
  ...
  analyzeImage: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      const enhancement = await db.accessibilityEnhancement.create({
        data: {
          contentId: input.contentId,
          contentType: 'image',
  ...
  analyzeSentiment: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      ...
      const sentiment = await db.sentimentAnalysis.create({
        data: {
          contentId: input.contentId,
          contentType: input.contentType,
  ...
  getSentimentAnalysis: protectedProcedure
    ...
    .query(async ({ ctx: _ctx, input }) => {
      return db.sentimentAnalysis.findFirst({
        where: {
          contentId: input.contentId,
          contentType: input.contentType,
        },
  ...
  getEnhancementStats: protectedProcedure
    ...
    .query(async ({ ctx: _ctx, input }) => {
      const [suggestions, summary, moderations, translations, sentiments] =
        await Promise.all([
          db.contentSuggestion.count({
            where: { campaignId: input.campaignId },
          }),
          db.campaignSummary.findUnique({
            where: { campaignId: input.campaignId },
          }),
          ...
          db.sentimentAnalysis.findFirst({
            where: {
              contentId: input.campaignId,
              contentType: 'campaign',
            },
  ...
  getModerationQueue: protectedProcedure
    ...
    .query(async ({ ctx: _ctx, input }) => {
      ...
      const items = await db.contentModeration.findMany({
        where: whereClause,
        take: input.limit,
        skip: input.offset,
        orderBy: { createdAt: 'desc' },
      ...
      const total = await db.contentModeration.count({
        where: whereClause,
      });
  ...
  updateModerationStatus: protectedProcedure
    ...
    .mutation(async ({ ctx: _ctx, input }) => {
      return db.contentModeration.update({
        where: { id: input.id },
  ...
  getAccessibilityEnhancements: protectedProcedure
    ...
    .query(async ({ ctx: _ctx, input }) => {
      return db.accessibilityEnhancement.findMany({
        where: {
          contentId: input.contentId,
          contentType: input.contentType,
        },
