if (!self.define) {
  ...
  self.define = (i, n) => {
    ...
    s[t] = Promise.all(i.map((e) => r[e] || d(e))).then((e) => (n(...e), c));
  };
}
define(['./workbox-b8918663'], function (e) {
  'use strict';
  (importScripts('fallback-I3vYfsFzwdyO_V45dpumJ.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        {
          ...
          revision: 'b730a0a35b8b4c8842a78ad7ebb5a741',
        },
        {
        ...
        {
          url: '/_next/static/I3vYfsFzwdyO_V45dpumJ/_buildManifest.js',
          revision: '69d63a96b217d4081215dd738b671ec2',
        },
        {
          url: '/_next/static/I3vYfsFzwdyO_V45dpumJ/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/153-2f901fdd5ed655fe.js',
          revision: 'I3vYfsFzwdyO_V45dpumJ',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/campaigns/create/page-7c9ad9acca0acc53.js',
          revision: 'I3vYfsFzwdyO_V45dpumJ',
        },
        {
        ...
        { url: '/offline', revision: 'I3vYfsFzwdyO_V45dpumJ' },
