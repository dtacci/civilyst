if (!self.define) {
  ...
  self.define = (a, t) => {
    ...
    e[n] = Promise.all(a.map((s) => d[s] || r(s))).then((s) => (t(...s), c));
  };
}
define(['./workbox-b8918663'], function (s) {
  'use strict';
  (importScripts('fallback-iR9V8s9Z05kUNBtayd4Hm.js'),
    self.skipWaiting(),
    s.clientsClaim(),
    s.precacheAndRoute(
      [
        {
          ...
          revision: '075e0d5733de2e408305384451de1c0d',
        },
        {
        ...
        },
        {
          ...
          revision: 'iR9V8s9Z05kUNBtayd4Hm',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/investment-demo/page-ff936b8fb901a111.js',
          revision: 'iR9V8s9Z05kUNBtayd4Hm',
        },
        {
        ...
        {
          url: '/_next/static/iR9V8s9Z05kUNBtayd4Hm/_buildManifest.js',
          revision: 'b5baafca86966401800d11f31b331df4',
        },
        {
          url: '/_next/static/iR9V8s9Z05kUNBtayd4Hm/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'iR9V8s9Z05kUNBtayd4Hm' },
        {
          url: '/sw-enhanced.js',
