...
define(['./workbox-b8918663'], function (e) {
  'use strict';
  (importScripts('fallback-nB3FQSZqpLxa624S98_Vw.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        {
          ...
          revision: '4bd2872a56651c2d39d588d040a9d400',
        },
        {
        ...
        },
        {
          ...
          revision: 'nB3FQSZqpLxa624S98_Vw',
        },
        {
        ...
        {
          url: '/_next/static/nB3FQSZqpLxa624S98_Vw/_buildManifest.js',
          revision: '0b5af72ac5e1fdfc5948c4337a3d82c1',
        },
        {
          url: '/_next/static/nB3FQSZqpLxa624S98_Vw/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'nB3FQSZqpLxa624S98_Vw' },
