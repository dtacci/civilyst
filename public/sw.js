if (!self.define) {
  ...
  self.define = (t, i) => {
    ...
    s[n] = Promise.all(t.map((e) => p[e] || r(e))).then((e) => (i(...e), c));
  };
}
define(['./workbox-b8918663'], function (e) {
  'use strict';
  (importScripts('fallback-atKRQvAjR25BpHz6VArpS.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        {
          ...
          revision: '7ca81def8ac515ce2b59355dd7313b7d',
        },
        {
        ...
        {
          url: '/_next/static/atKRQvAjR25BpHz6VArpS/_buildManifest.js',
          revision: 'b5baafca86966401800d11f31b331df4',
        },
        {
          url: '/_next/static/atKRQvAjR25BpHz6VArpS/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/0e5ce63c-8817714ae70b42a0.js',
          revision: 'atKRQvAjR25BpHz6VArpS',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/layout-1d11525ff936a078.js',
          revision: 'atKRQvAjR25BpHz6VArpS',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/page-d089cbcf52eed2c5.js',
          revision: 'atKRQvAjR25BpHz6VArpS',
        },
        {
        ...
        { url: '/offline', revision: 'atKRQvAjR25BpHz6VArpS' },
        {
          url: '/sw-enhanced.js',
