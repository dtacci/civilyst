...
define(['./workbox-b8918663'], function (e) {
  'use strict';
  (importScripts('fallback-zHGC7aQe5ljkpSb6XAq_r.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        {
          ...
          revision: '54daf3b8f6f4345e2a921d09de2e88af',
        },
        {
        ...
        },
        {
          ...
          revision: 'zHGC7aQe5ljkpSb6XAq_r',
        },
        {
        ...
        {
          url: '/_next/static/zHGC7aQe5ljkpSb6XAq_r/_buildManifest.js',
          revision: 'b5baafca86966401800d11f31b331df4',
        },
        {
          url: '/_next/static/zHGC7aQe5ljkpSb6XAq_r/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'zHGC7aQe5ljkpSb6XAq_r' },
        {
          url: '/sw-enhanced.js',
