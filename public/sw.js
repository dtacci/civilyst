if (!self.define) {
  ...
  self.define = (c, a) => {
    ...
    s[n] = Promise.all(c.map((e) => d[e] || r(e))).then((e) => (a(...e), t));
  };
}
define(['./workbox-b8918663'], function (e) {
  'use strict';
  (importScripts('fallback-ic3g7y6dXgIOTb2TL2S8w.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        {
          ...
          revision: 'ad7f2a0c077a622618fbd510cc13a6ce',
        },
        {
        ...
        },
        {
          ...
          revision: 'ic3g7y6dXgIOTb2TL2S8w',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/dashboard/page-2a7dba93c7b544be.js',
          revision: 'ic3g7y6dXgIOTb2TL2S8w',
        },
        {
        ...
        {
          url: '/_next/static/ic3g7y6dXgIOTb2TL2S8w/_buildManifest.js',
          revision: '0b5af72ac5e1fdfc5948c4337a3d82c1',
        },
        {
          url: '/_next/static/ic3g7y6dXgIOTb2TL2S8w/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'ic3g7y6dXgIOTb2TL2S8w' },
