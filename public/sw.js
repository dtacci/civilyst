if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    let t = {};
    const p = (s) => n(s, c),
      r = { module: { uri: c }, exports: t, require: p };
    e[c] = Promise.all(i.map((s) => r[s] || p(s))).then((s) => (a(...s), t));
  };
}
define(['./workbox-b8918663'], function (s) {
  'use strict';
  (importScripts('fallback-pbpdqXsfolXvn100pK_VE.js'),
    self.skipWaiting(),
    s.clientsClaim(),
    s.precacheAndRoute(
      [
        {
          ...
          revision: '2e7d5c6e50796cda64499304ef58d71c',
        },
        {
        ...
        },
        {
          ...
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
        ...
        {
          url: '/_next/static/chunks/8501-b1479734e1e19910.js',
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/layout-2d9295525d7520be.js',
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/sign-in/%5B%5B...sign-in%5D%5D/page-50d89498c6b1f5be.js',
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
          url: '/_next/static/chunks/app/sign-up/%5B%5B...sign-up%5D%5D/page-79a2bcc911d56f3c.js',
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
        ...
        {
          url: '/_next/static/chunks/webpack-b9122673df5c3da0.js',
          revision: 'pbpdqXsfolXvn100pK_VE',
        },
        {
        ...
        {
          url: '/_next/static/pbpdqXsfolXvn100pK_VE/_buildManifest.js',
          revision: 'b5baafca86966401800d11f31b331df4',
        },
        {
          url: '/_next/static/pbpdqXsfolXvn100pK_VE/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'pbpdqXsfolXvn100pK_VE' },
        {
          url: '/sw-enhanced.js',
